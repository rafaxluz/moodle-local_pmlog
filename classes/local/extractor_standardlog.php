...
class extractor_standardlog {
    /**
     * Get an empty recordset with the expected shape.
     *
     * @return \moodle_recordset
     */
    private function get_empty_recordset(): \moodle_recordset {
        global $DB;
     ...
     * @return \moodle_recordset Raw events.
     */
    public function extract(
        ...
        if ($studentonly) {
            ...
            if (!$context) {
                return $this->get_empty_recordset();
            }
